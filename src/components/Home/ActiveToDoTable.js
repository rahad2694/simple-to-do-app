...
const ActiveToDoTable = ({ item, index }) => {
    ...
    return (
        <tr>
            ...
            <td><button onClick={() => handleStrikeThrough(_id)} className='btn text-white hidden md:block'>Mark Complete</button><button title='Mark Complete?' onClick={() => handleStrikeThrough(_id)} className='btn text-white md:hidden'><FontAwesomeIcon icon={faCheck} /></button></td>
